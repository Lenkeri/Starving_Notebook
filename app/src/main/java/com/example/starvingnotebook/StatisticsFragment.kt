...
class StatisticsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val chartData = mutableListOf<Entry>(
            ...
            Entry(1631095570f, 58.4f),
            Entry(1632095570f, 56.5f),
            Entry(1633095570f, 55.2f),
            Entry(1634095570f, 58.8f),
            Entry(1635095570f, 61.2f),
            Entry(1636095570f, 60.0f),
            Entry(1637095570f, 61.9f),
            Entry(1638095570f, 63.1f),
            Entry(1639095570f, 62.5f),
            Entry(1640095570f, 61.4f),
            Entry(1641095570f, 57.5f),
            Entry(1642095570f, 56.7f),
            Entry(1643095570f, 58.9f),
            Entry(1644095570f, 59.2f),
            Entry(1645095570f, 60.3f),
            Entry(1646095570f, 60.7f),
            Entry(1647095570f, 57.8f),
            Entry(1648095570f, 60.0f),
            Entry(1649095570f, 59.2f),
            Entry(1650095570f, 57.8f),
            Entry(1651095570f, 57.9f),
            Entry(1652095570f, 58.2f),
            Entry(1653095570f, 60.7f),
            Entry(1654095570f, 60.0f),
        )
        val dataset = LineDataSet(chartData, "Weight")
        dataset.setColor(Color.parseColor("#68b88a"))
